...
| 验证项 | 结果 |
|--------|------|
| `cd backend && mvn clean test` | **66+ 用例全绿**，BUILD SUCCESS |
...
| 各平台增速 | 单平台 Tab 占位文案 | ✅ `CategoryBriefBuilder` 输出该平台月增速 |
| Top10 销量占比 | 竞争图未展示 | ✅ `CompetitionMap` tooltip |
